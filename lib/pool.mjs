...
export async function snapshotQueue(client) {
  ...
  requireConfig(SETTINGS, ["projectName", "regionNameEng", "queueName", "gpuModel"], "queue probe ");
...
export async function snapshotQueueOfficial(official) {
  ...
  requireConfig(SETTINGS, ["regionNameEng", "queueName", "gpuModel"], "queue probe (official) ");
